...
function clEmailHTML(c, ds){
  ...
  function bullets(arr){ return arr.length? arr.map(function(t){return '&bull; '+e(t);}).join('<br>') : '<span style="color:#4F4535;">—</span>'; }
