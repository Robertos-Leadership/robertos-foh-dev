  ...
  'coo-events-2': {
    ...
    items: [
      ...
      { said: 'You said: “minimum target sale expressed in number of events and revenue”.',
        ...
        shipped: { build:'2026-07-18.1', in:'8de7b9a', what:'The Monthly report now carries a target for the month, and measures the month against it: target, converted so far, and what is still to find — gross and net, both, as you asked. Your <b>AED 150,000</b> is in for July and August. Valentina never touches it.<br><br><b>One thing we did not do:</b> you asked for the target as a number of events <i>and</i> revenue, and gave us the revenue. The <b>event count is empty</b>, and the card says so — we would not put a number on your report that you did not give us. Tell us the count and it goes in.', check:'Events → Monthly report → “Target for August”. It reads AED 150,000 against what has converted, with the shortfall and the % of target. The number-of-events box is blank and says why.' },
